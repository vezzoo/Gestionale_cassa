...
<div id="cacca" style="top: 0; left: 0; width: 148mm; min-height: 210mm; background-color: #FFF">
    ...
    <div style="float: right;"><h1 style="float: right; margin: 20px; margin-bottom: 1px; margin-top: 8px" id="machecazz"><?php echo $properties["event_name"]; ?></h1></div>
...
<?php
$qqq = true;
 if(in_array("BAR", $gruppi) && !in_array("CUCINA", $gruppi)){
	echo "<script>document.getElementById('machecazz').innerHTML = 'BAR'; </script>";
	$qqq = false; 
}
?>

<div style=" width: 148mm; height: 210mm; background-color: #FFF; display: <?php  if(in_array("BAR", $gruppi) && $qqq) echo "block"; else echo "none"; ?>">
    <div style="float: left;"><h1 style="margin: 20px; margin-bottom: 1px"><?php echo $order_num ?></h1></div>
